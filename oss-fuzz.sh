...
coverpkg="github.com/deso-protocol/uint256/..."
...
compile_fuzzer github.com/deso-protocol/uint256  FuzzUnaryOperations fuzzUnary $repo/unary_test.go,$repo/shared_test.go
compile_fuzzer github.com/deso-protocol/uint256  FuzzBinaryOperations fuzzBinary $repo/binary_test.go,$repo/shared_test.go
compile_fuzzer github.com/deso-protocol/uint256  FuzzCompareOperations fuzzCompare $repo/binary_test.go,$repo/shared_test.go
compile_fuzzer github.com/deso-protocol/uint256  FuzzTernaryOperations fuzzTernary $repo/ternary_test.go,$repo/shared_test.go
compile_fuzzer github.com/deso-protocol/uint256  FuzzSetString fuzzSetString $repo/conversion_fuzz_test.go,$repo/shared_test.go
